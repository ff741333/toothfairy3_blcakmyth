...
class WNet2D(nn.Module):
    def __init__(self, in_channel, num_classes, deep_supervised, layer_channel=[32, 64, 128, 256, 320], global_dim=[16, 32, 64, 128, 160], num_heads=[1, 2, 4, 8], sr_ratio=[8, 4, 2, 1]):
...
class nnUNetTrainer_WNet2D_L(nnUNetTrainer):
    def __init__(
        self,
        plans: dict,
        configuration: str,
