...
class WNet3D(nn.Module):
    def __init__(self, in_channel, num_classes, deep_supervised, layer_channel=[24, 48, 96, 192, 256], global_dim=[12, 24, 48, 96, 128], num_heads=[1, 2, 4, 8], sr_ratio=[8, 4, 2, 1], fusion_method='channel'):
